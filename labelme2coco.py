...
class labelme2coco(object):
    ...
    def image(self, data, num):
        ...
        if data["imageData"] == None:
            print('--'+data['imagePath'] + ': no image data')
            img = utils.img_data_to_arr(LabelFile.load_image_file(args.labelme_images+data["imagePath"]))
        else:
            print(data['imagePath'] + ': has image data')
